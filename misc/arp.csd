...
giPresets[][] init 6, 20
giPresets fillarray 0,   2,  .5,   0,  -5,  0,   2,   0.5, 0,   5,   12,  .01,  2,    .01,  .1,  0,   .005, .01, 1,   .05, \
                   .2,  2,  .5,   0,  -5,  .2,  2,   0.5, 0,    5,   1,   .01,  1,    .1,   .1,  .5,  .005, .01, 1,   .05, \
                   ...
                   1,   2,  .01,  -2, 0,   .2,  3,   0.5, 0,    0,   40,  5,    5,    .001, 1.5, .1,  .005, .01, 1,   .05
...
instr 2
 ...
 kmetro metro 1/kdur
	if kmetro == 1 then
		event "i", 1, 0, kdur, knote, giPresets[ipre][0],giPresets[ipre][1],giPresets[ipre][2],giPresets[ipre][3],giPresets[ipre][4],giPresets[ipre][5],giPresets[ipre][6],giPresets[ipre][7],giPresets[ipre][8],giPresets[ipre][9],giPresets[ipre][10],giPresets[ipre][11],giPresets[ipre][12],giPresets[ipre][13],giPresets[ipre][14],giPresets[ipre][15],giPresets[ipre][16],giPresets[ipre][17],giPresets[ipre][18],giPresets[ipre][19]
	 kndx += 1
	 kndx = kndx % 4
	endif
endin
